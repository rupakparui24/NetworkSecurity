...
class DataTransformation:
    ...
    def get_transformer_object(self) -> Pipeline:
        logging.info("Entered the get_transformer_object method of DataTransformation class")
        try:
            imputer: KNNImputer = KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)
            logging.info(f"initialize imputer with : {DATA_TRANSFORMATION_IMPUTER_PARAMS}")
    ...
    def initiate_data_transformation(self)-> DataTransformationArtifact:
        ...
        try:
            ...
            logging.info("Preprocessor object created and trained")

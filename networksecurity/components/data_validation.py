from networksecurity.entity.artifact_entity import DataIngestionArctifact, DataValidationArtifact
...
class DataValidation:
    def __init__(self, data_ingestion_artifact: DataIngestionArctifact, data_validation_config: DataValidationConfig):
        try:
